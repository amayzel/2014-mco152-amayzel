...
public class Event implements Comparable<Event> {
	...
	public int compareTo(Event a) {
		Integer timeOfDay = Integer.parseInt(String.valueOf(this.timeOfDay));
		Integer thisTimeOfDay = Integer.parseInt(String.valueOf(a.getTimeOfDay()));

		return timeOfDay.compareTo(thisTimeOfDay);
	}
